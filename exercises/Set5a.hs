...
get :: UpDown -> Int
get (UpDownUndefined1 n) = n
get (UpDownUndefined2 n) = n

-- tick increases an increasing counter by one or decreases a
-- decreasing counter by one
tick :: UpDown -> UpDown
tick (UpDownUndefined1 n) = (UpDownUndefined1 (n+1))
tick (UpDownUndefined2 n) = (UpDownUndefined2 (n-1))

-- toggle changes an increasing counter into a decreasing counter and
-- vice versa
toggle :: UpDown -> UpDown
toggle (UpDownUndefined1 n) = UpDownUndefined2 n
toggle (UpDownUndefined2 n) = UpDownUndefined1 n
